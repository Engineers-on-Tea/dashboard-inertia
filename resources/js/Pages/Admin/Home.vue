                                            ...
                                            <td class="w-40">
                                                <div class="flex">
                                                    ...
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <Tippy tag="img" alt="Midone Tailwind HTML Admin Template"
                                                            class="rounded-full" :src="faker.images[1]"
                                                            :content="`Uploaded at ${faker.dates[1]}`" />
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <Tippy tag="img" alt="Midone Tailwind HTML Admin Template"
                                                            class="rounded-full" :src="faker.images[2]"
                                    ...
                                    <div class="intro-x relative flex items-center mb-3">
                                        ...
                                        <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                            ...
                                            <div class="text-slate-500">
                                                ...
                                                <div class="flex mt-2">
                                                    <Tippy tag="div" class="w-8 h-8 image-fit mr-1 zoom-in"
                                                        :content="$f()[0].products[0].name">
                                                        <img alt="Midone Tailwind HTML Admin Template"
                                                            class="rounded-md border border-white" :src="$f()[8].images[0]" />
                                                    </Tippy>
                                                    <Tippy tag="div" class="w-8 h-8 image-fit mr-1 zoom-in"
                                                        :content="$f()[1].products[0].name">
                                                        <img alt="Midone Tailwind HTML Admin Template"
                                                            class="rounded-md border border-white" :src="$f()[8].images[1]" />
                                                    </Tippy>
                                                    <Tippy tag="div" class="w-8 h-8 image-fit mr-1 zoom-in"
                                                        :content="$f()[2].products[0].name">
                                                        <img alt="Midone Tailwind HTML Admin Template"
                                                            class="rounded-md border border-white" :src="$f()[8].images[2]" />
                                                    </Tippy>
                                                </div>
                                            </div>
                                        </div>
...
import SideMenuMain from "../Admin/Layouts/side-menu/Main.vue";
