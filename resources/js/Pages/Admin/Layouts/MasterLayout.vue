<script setup>
import Preloader from "@/Pages/Admin/Layouts/Preloader.vue";
</script>
<template>
    <!-- Pre-loader start -->
    <Preloader />
                    ...
                    <div class="navbar-container container-fluid">
                        <ul class="nav-left">
                            <li class="header-search">
                                <div class="main-search morphsearch-search">
                                    <div class="input-group">
                                        <span
                                            class="input-group-addon search-close"
                                        ...
                                        />
                                        <span
                                            class="input-group-addon search-btn"
                            ...
                            <li>
                                ...
                                >
                                    <i
                                        class="feather icon-maximize full-screen"
                                    ></i>
                                </a>
                            </li>
                        </ul>
                    ...
                    <nav class="pcoded-navbar">
                        <div class="pcoded-inner-navbar main-menu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="pcoded-hasmenu">
                                            ...
                                            <ul class="pcoded-submenu">
                                                <li class=" ">
                                                    <a
                                                        href="menu-horizontal-static.htm"
                                                        target="_blank"
                                                    >
                                                        <span
                                                            class="pcoded-mtext"
                                                ...
                                                <li class=" ">
                                                    <a
                                                        href="menu-horizontal-fixed.htm"
                                                        target="_blank"
                                                    >
                                                        <span
                                                            class="pcoded-mtext"
                                                ...
                                                <li class=" ">
                                                    <a
                                                        href="menu-horizontal-icon-fixed.htm"
                                                        target="_blank"
                                                    >
                                                        <span
                                                            class="pcoded-mtext"
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class=" ">
                                    <a href="animation.htm">
                                        <span class="pcoded-micon"
                                            ><i
                                                class="feather icon-aperture rotate-refresh"
                                            ></i
                                            ><b>A</b></span
                                        >
                                        <span class="pcoded-mtext"
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a
                                                href="form-elements-component.htm"
                                            >
                                                <span class="pcoded-mtext"
                                                    >Form Components</span
                                                >
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a
                                                href="ready-cloned-elements-form.htm"
                                            >
                                                <span class="pcoded-mtext"
                                        ...
                                        <li class=" ">
                                            <a
                                                href="ready-form-booking-multi-steps.htm"
                                            >
                                                <span class="pcoded-mtext"
                                                    >Booking Multi Steps
                                                    Form</span
                                        ...
                                        <li class=" ">
                                            <a
                                                href="ready-job-application-form.htm"
                                            >
                                                <span class="pcoded-mtext"
                                        ...
                                        <li class=" ">
                                            <a
                                                href="ready-js-addition-form.htm"
                                            >
                                                <span class="pcoded-mtext"
                                        ...
                                        <li class=" ">
                                            <a
                                                href="ready-popup-modal-form.htm"
                                                target="_blank"
                                            >
                                                <span class="pcoded-mtext"
                                        ...
                                        <li class=" ">
                                            <a
                                                href="ready-registration-form.htm"
                                            >
                                                <span class="pcoded-mtext"
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="pcoded-hasmenu">
                                            ...
                                            <ul class="pcoded-submenu">
                                                ...
                                                <li class=" ">
                                                    <a
                                                        href="dt-ext-buttons-html-5-data-export.htm"
                                                    >
                                                        <span
                                                            class="pcoded-mtext"
                                                            >Html-5 Data
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="">
                                            <a
                                                href="handson-data-operation.htm"
                                            >
                                                <span class="pcoded-mtext"
                                                    >Data Operation</span
                                                >
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <a
                                        href="..\files\extra-pages\landingpage\index.htm"
                                        target="_blank"
                                    >
                                        <span class="pcoded-micon"
                                            ><i
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="">
                                            <a
                                                href="auth-sign-in-social-header-footer.htm"
                                                target="_blank"
                                            >
                                                <span class="pcoded-mtext"
                                                    >Login Social With Header
                                                    And Footer</span
                                                >
                                            </a>
                                        </li>
                                        <li class="">
                                            <a
                                                href="auth-normal-sign-in-header-footer.htm"
                                                target="_blank"
                                            >
                                                <span class="pcoded-mtext"
                                                    >Login With Header And
                                                    Footer</span
                                                >
                                            </a>
                                        </li>
                                        ...
                                        <li class="">
                                            <a
                                                href="auth-sign-up-social-header-footer.htm"
                                                target="_blank"
                                            >
                                                <span class="pcoded-mtext"
                                                    >Registration Social With
                                        ...
                                        <li class="">
                                            <a
                                                href="auth-sign-up-header-footer.htm"
                                                target="_blank"
                                            >
                                                <span class="pcoded-mtext"
                                        ...
                                        <li class="">
                                            <a
                                                href="auth-multi-step-sign-up.htm"
                                                target="_blank"
                                            >
                                                <span class="pcoded-mtext"
                                                    >Multi Step
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="pcoded-hasmenu">
                                            ...
                                            <ul class="pcoded-submenu">
                                                <li class="">
                                                    <a
                                                        href="..\files\extra-pages\email-templates\email-welcome.htm"
                                                    >
                                                        <span
                                                            class="pcoded-mtext"
                                                            >Welcome Email</span
                                                ...
                                                <li class="">
                                                    <a
                                                        href="..\files\extra-pages\email-templates\email-password.htm"
                                                    >
                                                        <span
                                                            class="pcoded-mtext"
                                                            >Reset
                                                ...
                                                <li class="">
                                                    <a
                                                        href="..\files\extra-pages\email-templates\email-launch.htm"
                                                    >
                                                        <span
                                                            class="pcoded-mtext"
                                                            >App Launch</span
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div
                                                    class="card bg-c-yellow update-card"
                                                >
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div
                                                    class="card bg-c-green update-card"
                                                >
                                                    <div class="card-block">
                                                        <div
                                                            class="row align-items-end"
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div
                                                    class="card bg-c-pink update-card"
                                                >
                                                    <div class="card-block">
                                                        <div
                                                            class="row align-items-end"
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div
                                                    class="card bg-c-lite-green update-card"
                                                >
                                                    <div class="card-block">
                                                        <div
                                                            class="row align-items-end"
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <li>
                                                                    <i
                                                                        class="feather icon-trash-2 close-card"
                                                                    ></i>
                                                                </li>
                                                            </ul>
                                                        </div>
                                            ...
                                            <div class="col-xl-3 col-md-12">
                                                <div class="card user-card2">
                                                    ...
                                                    >
                                                        ...
                                                        <a
                                                            href="#!"
                                                            class="text-c-yellow b-b-warning"
                                                            >Change Your Risk</a
                                                        >
                                                        <div
                                                    ...
                                                    <button
                                                        class="btn btn-warning btn-block p-t-15 p-b-15"
                                                    >
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row m-b-25">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                >
                                                                    <i
                                                                        class="feather icon-clock m-r-10"
                                                                    ></i
                                                                    >2 min ago
                                                                </p>
                                                            </div>
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <p
                                                                        class="text-muted m-b-0 d-inline"
                                                                    >
                                                                        4 hrs
                                                                        ago
                                                                    </p>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <i
                                                                    class="feather icon-edit m-t-10 f-16"
                                                                ></i>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-8">
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <div
                                                    class="card social-card bg-simple-c-blue"
                                                >
                                                    <div class="card-block">
                                                        <div
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <i
                                                                    class="feather icon-mail f-34 text-c-blue social-icon"
                                                                ></i>
                                                            </div>
                                                            <div class="col">
                                                                <h6
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <div
                                                    class="card social-card bg-simple-c-pink"
                                                >
                                                    <div class="card-block">
                                                        <div
                                                            class="row align-items-center"
                                                        >
                                                            ...
                                                            >
                                                                <i
                                                                    class="feather icon-twitter f-34 text-c-pink social-icon"
                                                                ></i>
                                                            </div>
                                                            <div class="col">
                                                                <h6
                                            ...
                                            <div class="col-xl-4 col-md-12">
                                                <div
                                                    class="card social-card bg-simple-c-green"
                                                >
                                                    <div class="card-block">
                                                        <div
                                                            class="row align-items-center"
