                ...
                <li class="nav-item dropdown dropdown-language">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-flag">
                        <a v-for="langs in $page.props.languages" class="dropdown-item"
                            ...
                            <i :class="'flag-icon ' + langs['flag']"></i>
                            {{ langs['title'] }}
                        </a>
                    </div>
                </li>
                            ...
                            <a class="d-flex" href="#">
                                <div class="list-item d-flex align-items-start">
                                    ...
                                    <div class="list-item-body flex-grow-1">
                                        ...
                                        <small class="notification-text">
                                            USA Server is down due to high CPU
                                            usage</small>
                                    </div>
                                </div>
                            </a><a class="d-flex" href="#">
                    ...
                    <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#"
                        ...
                        <div class="user-nav d-sm-flex d-none">
                            ...
                            <span class="user-status">
                                {{ $page.props.auth.user.guard_name }}
                            </span>
                        </div>
                        <span class="avatar">
                            <img class="round" :src="$page.props.auth.user.image" alt="avatar" height="40" width="40" />
