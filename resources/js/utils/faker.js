...
const fakers = {
  ...
  fakePhotos() {
    ...
    for (let i = 0; i < 15; i++) {
      photos[photos.length] =
        imageAssets[
          "../../../resources/assets/images/profile-" + _.random(1, 15) + ".jpg"
        ];
    }
  ...
  fakeFoods() {
    const foods = [
      {
        name: "Vanilla Latte",
        image: imageAssets["/src/assets/images/food-beverage-1.jpg"],
      },
      {
        name: "Milkshake",
        image: imageAssets["/src/assets/images/food-beverage-2.jpg"],
      },
      {
        name: "Soft Drink",
        image: imageAssets["/src/assets/images/food-beverage-3.jpg"],
      },
      {
        name: "Root Beer",
        image: imageAssets["/src/assets/images/food-beverage-4.jpg"],
      },
      {
        name: "Pocari",
        image: imageAssets["/src/assets/images/food-beverage-5.jpg"],
      },
      {
        name: "Ultimate Burger",
        image: imageAssets["/src/assets/images/food-beverage-6.jpg"],
      },
      {
        name: "Hotdog",
        image: imageAssets["/src/assets/images/food-beverage-7.jpg"],
      },
      {
        name: "Avocado Burger",
        image: imageAssets["/src/assets/images/food-beverage-8.jpg"],
      },
      {
        name: "Spaghetti Fettucine Aglio with Beef Bacon",
        image: imageAssets["/src/assets/images/food-beverage-9.jpg"],
      },
      {
        name: "Spaghetti Fettucine Aglio with Smoked Salmon",
        image: imageAssets["/src/assets/images/food-beverage-10.jpg"],
      },
      {
        name: "Curry Penne and Cheese",
        image: imageAssets["/src/assets/images/food-beverage-11.jpg"],
      },
      {
        name: "French Fries",
        image: imageAssets["/src/assets/images/food-beverage-12.jpg"],
      },
      {
        name: "Virginia Cheese Fries",
        image: imageAssets["/src/assets/images/food-beverage-13.jpg"],
      },
      {
        name: "Virginia Cheese Wedges",
        image: imageAssets["/src/assets/images/food-beverage-14.jpg"],
      },
      {
        name: "Fried/Grilled Banana",
        image: imageAssets["/src/assets/images/food-beverage-15.jpg"],
      },
      {
        name: "Crispy Mushroom",
        image: imageAssets["/src/assets/images/food-beverage-16.jpg"],
      },
      {
        name: "Fried Calamari",
        image: imageAssets["/src/assets/images/food-beverage-17.jpg"],
      },
      {
        name: "Chicken Wings",
        image: imageAssets["/src/assets/images/food-beverage-18.jpg"],
      },
      {
        name: "Snack Platter",
        image: imageAssets["/src/assets/images/food-beverage-19.jpg"],
      },
    ];
